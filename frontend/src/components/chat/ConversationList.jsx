      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar">
        {conversations.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-gray-400 dark:text-gray-600 p-8 text-center animate-in fade-in duration-500">
            <div className="w-16 h-16 bg-gray-50 dark:bg-gray-900 rounded-3xl flex items-center justify-center mb-4 shadow-sm">
              <svg width="28" height="28" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="opacity-50">
            ...
            <p className="text-xs mt-1 text-gray-400 dark:text-gray-500">Tap the + icon to start chatting</p>
          </div>
        ) : (
            ...
            {conversations.map(conv => {
              ...
              return (
                <div
                  ...
                  className={`
                    group relative flex items-center p-3 cursor-pointer rounded-2xl transition-all duration-200 active:scale-[0.98]
                    ${isSelected
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-baseline mb-0.5 gap-2">
                      <h3 className={`text-sm font-bold truncate flex items-center gap-1.5 ${isSelected ? 'text-blue-700 dark:text-blue-400' : 'text-gray-900 dark:text-gray-100'}`}>
                        {displayName}
                        {conv.isGroup && (
                          <span className="text-[9px] px-1.5 py-0.5 bg-gray-100 dark:bg-gray-800 text-gray-500 rounded-md font-medium uppercase tracking-tighter flex-shrink-0">
                            Group
                          </span>
                        )}
                      </h3>
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <button
                        ...
                        className="opacity-0 group-hover:opacity-100 p-1 text-gray-300 dark:text-gray-600 hover:text-red-500 dark:hover:text-red-400 transition-all transform hover:scale-110 flex-shrink-0"
      ...
      <div className="p-3">
        <div className="bg-gray-50 dark:bg-gray-900/60 rounded-2xl border border-gray-100 dark:border-gray-800 px-3 py-2.5 flex items-center gap-3">
          ...
          <button
            ...
            className="p-2 text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-all active:scale-90 flex-shrink-0"
            aria-label="Logout"
          >
