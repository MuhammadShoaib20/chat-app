...
const MessageActions = ({ onEdit, onDelete, isOwn }) => {
  ...
  return (
    <div className="relative inline-block leading-none" ref={menuRef}>
      ...
      {/* Dropdown */}
      {showMenu && (
        <div className="absolute right-0 mt-2 w-40 bg-white/95 dark:bg-gray-900/98 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-800 py-1.5 z-50 animate-in fade-in zoom-in-95 slide-in-from-top-2 duration-200 origin-top-right">
          ...
          >
            <div className="p-1 rounded-lg bg-red-50 dark:bg-red-900/20 group-hover:bg-red-100 dark:group-hover:bg-red-800/60 transition-colors">
              <svg width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
