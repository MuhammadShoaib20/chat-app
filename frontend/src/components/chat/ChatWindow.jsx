  ...
  if (!conversationId) {
    return (
      <div className="h-full flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-950 p-6 text-center animate-in fade-in duration-500">
        <div className="w-20 h-20 bg-blue-100 dark:bg-blue-900/30 rounded-2xl flex items-center justify-center mb-4 shadow-md">
        ...
        <p className="text-gray-500 dark:text-gray-400 font-medium text-sm">Select a conversation to start chatting</p>
      </div>
    );
  }
    ...
    <div className="flex flex-col h-full bg-white dark:bg-gray-950 overflow-hidden relative">
      ...
      <div className="sticky top-0 z-20 flex items-center justify-between px-4 py-3 md:px-5 md:py-4 bg-white/80 dark:bg-gray-950/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-800 gap-2">
        ...
        <div className="flex items-center gap-1 md:gap-2">
          ...
          >
            <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" /></svg>
          </button>
          ...
          {!conversation?.isGroup && otherParticipant && (
            ...
            >
              <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" /></svg>
            </button>
          )}
      ...
      <div
        ...
        className="flex-1 overflow-y-auto px-4 py-4 md:px-5 space-y-6 bg-gray-50 dark:bg-gray-950 scroll-smooth"
      >
        {loadingInitial ? (
      ...
      {/* Input area */}
      <div className="p-3 md:p-4 border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-950">
        <MessageInput
        ...
        {(blockStatus.hasBlocked || blockStatus.isBlockedBy) && (
          <p className="text-xs text-center text-red-500 font-bold uppercase tracking-tighter mt-2">
