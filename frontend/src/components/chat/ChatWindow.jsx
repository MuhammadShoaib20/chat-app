...
const ChatWindow = ({
  ...
  if (!conversationId) {
    return (
      <div className="h-dvh flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-950 p-6 text-center animate-in fade-in duration-500">
  ...
  return (
    <div className="flex flex-col h-dvh max-h-dvh bg-white dark:bg-gray-950 relative overflow-hidden">
